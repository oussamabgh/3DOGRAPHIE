...
public class NetMusic extends Application {
    ...
    double mouseDeltaX;
    double mouseDeltaY;
   public void setGrp(Group rooot) {
	   this.group.getChildren().addAll(rooot.getChildren());
   }
    ...
    private void buildChart() {
        ...
        world.getChildren().addAll(group.getChildren());
    }
    ...
    public void start(Stage primaryStage) {
        ...
        Scene scene = new Scene(root, 1220, 660, true);
